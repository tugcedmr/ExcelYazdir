...
ws = wb.active
os.system("md morevim1")  #klasör olusturma
os.chdir(r'C:\Users\LENOVO\Desktop\morevim1')   #klasöre gitme
for dongu in range(2,ws.max_row+1):
    ...
    def DosyaYazdir():   
        dosya = open(str(Gsutun.replace(" ", ""))+(str(re.sub(r"\s+$", "",Isutun, flags=re.UNICODE))+format(dongu-1))+'.js','w+',encoding="utf-8")  #dosyayı açma ve isim verme
